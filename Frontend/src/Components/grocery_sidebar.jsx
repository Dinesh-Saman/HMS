  ...
  return (
    <SidebarContainer>
      ...
      <Menu>
        ...
        <Link to="/view-grocery-items" style={{ textDecoration: 'none', color: 'inherit' }}>
          <MenuItem>
            <Icon><FaUsers /></Icon>
            View Grocery Items
          </MenuItem>
        </Link>
        <Link to="/add-grocery-item" style={{ textDecoration: 'none', color: 'inherit' }}>
          <MenuItem>
            <Icon><FaUserPlus /></Icon>
            Add Grocery Items
          </MenuItem>
        </Link>
        <Link to="/grocery-items-report" style={{ textDecoration: 'none', color: 'inherit' }}>
          <MenuItem>
            <Icon><FaFileAlt /></Icon>
            Grocery Report
          </MenuItem>
