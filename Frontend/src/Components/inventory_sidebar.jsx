  ...
  return (
    <SidebarContainer>
      ...
      <Menu>
        ...
        <Link to="/view-home-inventory" style={{ textDecoration: 'none', color: 'inherit' }}>
          <MenuItem>
            <Icon><FaUsers /></Icon>
            View Home Inventory
          </MenuItem>
        </Link>
        <Link to="/add-home-inventory" style={{ textDecoration: 'none', color: 'inherit' }}>
          <MenuItem>
            <Icon><FaUserPlus /></Icon>
            Add Home Inventory
          </MenuItem>
        </Link>
        <Link to="/home-inventory-report" style={{ textDecoration: 'none', color: 'inherit' }}>
          <MenuItem>
            <Icon><FaFileAlt /></Icon>
